...
== A нужна ли математика в тестировании?

image::beatester.png[]

== Многие обще-математические концепции переходят в практику
...
2. Формальная спецификация обычно очень многое абстрагирует
3. https://blog.acolyer.org/2015/10/15/ironfleet-proving-practical-distributed-systems-correc/[Cлучай Microsoft Iron Fleet]
